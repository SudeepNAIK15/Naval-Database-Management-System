...
public class Signup extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "SELECT", "ARMOURY", "TECHNICAL", "SERVICE", "FOOD" }));
   ...
   new login().setVisible(true);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String ra_nk = (String)jComboBox1.getSelectedItem();
        ...
        System.out.print(ra_nk);
            ...
            String query1 = "INSERT INTO SAILOR(fname,mname,lname,sainik_id,email,phone,ra_nk,dob,gender,experience,address,department) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
            String query2 = "INSERT INTO CAPTAIN(fname,mname,lname,sainik_id,email,phone,ra_nk,dob,gender,experience,address) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
            try {
                ...
                System.out.println("uvuhkbh");
                    ...
                    ps1.setString(4, sainik_id);
                    ps1.setString(12, Department);
                    ps1.setString(9, Gender);
                    ps1.setString(11, Address);
                    ps1.setString(10, Exp);
                    ps1.setString(7, ra_nk);
                    ...
                    ps2.setString(4, sainik_id);
                    ps2.setString(9, Gender);
                    ps2.setString(11, Address);
                    ps2.setString(10, Exp);
                    
                    ps2.setString(7, ra_nk);
